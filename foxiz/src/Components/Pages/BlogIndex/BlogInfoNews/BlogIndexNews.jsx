...
import { BlogIndex_news } from "../../../Mock/BlogIndex";
import { AiFillCaretRight } from "react-icons/ai";
import "../BlogInfoNews/BlogIndexNews.scss";
const BlogIndexNews = () => {
          ...
          <div className="col-lg-8">
            <div className="large_section">
              <div className="row mt-5 d-flex ">
                {BlogIndex_news &&
                  BlogIndex_news.map((el) => {
                    return (
                      <div key={el.id} className="col-lg-12 col-md-12">
